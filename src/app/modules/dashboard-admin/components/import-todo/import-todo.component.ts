...
datocurioso(){
  ...
  for (let index = 0; index < this.data2[0].length; index++) {
    this.atractivoTuristico = {
      ...
      latitud: this.data2[0][index].latitud === undefined || "--" || null  ? 0 : this.data2[0][index].latitud,
  ...
  for (let index = 0; index < this.data3[0].length; index++) {
   this.municipio = {
    ...
    latitud: this.data3[0][index].latitud === undefined || "--" || null  ? 0 : this.data3[0][index].latitud,
...
for (let index = 0; index < this.data4[0].length; index++) {
  this.ruta = {
    ...
    latitud: this.data4[0][index].latitud === undefined || "--" || null  ? 0 : this.data4[0][index].latitud,
