...
datocurioso(){
  ...
  for (let index = 0; index < this.data2[0].length; index++) {
    this.atractivoTuristico = {
      ...
      latitud: (this.data2[0][index].latitud)*1 === undefined || this.data2[0][index].latitud === "--" || (this.data2[0][index].latitud)*1 === null  ? 0 : (this.data2[0][index].latitud)*1,
      longitud: this.data2[0][index].longitud * -1 === undefined || this.data2[0][index].longitud === "--" || this.data2[0][index].longitud * -1 === null  ? 0 : this.data2[0][index].longitud * -1,
  ...
  for (let index = 0; index < this.data3[0].length; index++) {
   this.municipio = {
    ...
    latitud: (this.data3[0][index].latitud)*1 === undefined || this.data3[0][index].latitud === "--" || (this.data3[0][index].latitud)*1 === null  ? 0 : (this.data3[0][index].latitud)*1,
    longitud: this.data3[0][index].longitud * -1 === undefined || this.data3[0][index].longitud === "--" || this.data3[0][index].longitud * -1 === null  ? 0 : this.data3[0][index].longitud * -1,
...
for (let index = 0; index < this.data4[0].length; index++) {
  this.ruta = {
    ...
    latitud: (this.data4[0][index].latitud)*1 === undefined || this.data4[0][index].latitud === "--" || (this.data4[0][index].latitud)*1 === null  ? 0 : (this.data4[0][index].latitud)*1,
    longitud: this.data4[0][index].longitud * -1 === undefined || this.data4[0][index].longitud === "--" ||
    this.data4[0][index].longitud * -1 === null  ? 0 : this.data4[0][index].longitud * -1,
